...
----------------------------------
	...
	- Modélisation thématique : thèmes et/ou des sujets sous-jacents, allocation de Dirichlet latente (LDA) et la factorisation de
								matrice non négative (NMF).
...
#############################################################################
	...
	=> - Analyse des opinions et des sentiments des clients (page 11)
	=> - Assistance client améliorée : (page 11)
	=> - Études de marché et veille concurrentielle améliorées : (page 12)
	=> - Gestion efficace de la réputation de la marque : (page 12)
	=> - Marketing ciblé et marketing personnalisé : (page 13)
	=> - Identification et marketing des influenceurs : (page 14)
	=> - Gestion de crise et gestion des risques : (page 14)
	=> - Développement de produits et innovation : (page 14)
